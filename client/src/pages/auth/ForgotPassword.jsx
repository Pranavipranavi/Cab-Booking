      ...
      <div className="col-md-6 col-lg-5">
        <div className="ucab-card shadow-lg bg-white border rounded-4 p-4">
          <div className="text-center mb-4">
            <h2 className="fw-bold text-black mb-1">Reset Password</h2>
            <p className="text-muted">Enter your email address to receive password reset links</p>
          </div>
